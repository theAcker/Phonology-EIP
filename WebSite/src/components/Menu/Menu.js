...
class Menu extends React.Component {
  constructor(props) {
    ...
    this.items = [
      ...
      { to: "#project", label: "Le Projet", icon: FaTag },
      //{ to: "/search/", label: "Search", icon: FaSearch },
      //...pages,
      //{ to: "/products", label: "Produits", icon: FaTags },
      //{ to: "/reviews", label: "Avis", icon: FaStar },
      //{ to: "/services", label: "Services", icon: FaCubes },
      // { to: "#about", label: "A Propos", icon: FaInfoCircle },
      { to: "#team", label: "Équipe", icon: FaUsers },
